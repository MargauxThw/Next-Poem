...
export function FilterButton({ initiateFetch }: { initiateFetch: () => void }) {
	...
	const initialiseFilters = () => {
		...
		setLinesStart(localStorage.getItem("linesStart_browse") ?? "");
		setLinesEnd(localStorage.getItem("linesEnd_browse") ?? "");
	};
	...
	const saveFilters = () => {
		...
		localStorage.setItem("linesStart_browse", linesStart);
		localStorage.setItem("linesEnd_browse", linesEnd);
		initiateFetch();
	};
